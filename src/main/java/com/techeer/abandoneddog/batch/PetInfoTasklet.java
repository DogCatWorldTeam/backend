...
public class PetInfoTasklet implements Tasklet {
    ...
    public PetInfoTasklet(PetInfoRepository petInfoRepository, ShelterRepository shelterRepository, String secretKey) {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("PetInfoTasklet executed successfully");
        return RepeatStatus.FINISHED;
    }

    private void initializeExistingDesertionNos() {
        List<Long> desertionNos = petInfoRepository.findAllDesertionNos();
        existingDesertionNos.addAll(desertionNos);
        isInitialized = true;
    }

    private void getAllAndSaveInfo(String upkind, String bgnde, String endde) throws IOException, JSONException {
        int numOfRows = 1000;
        int pageNo = 1;
        int totalCount = 0;
            ...
            for (int i = 0; i < itemArray.length(); i++) {
                ...
                try {
                    ...
                    PetInfo petInfo = PetInfo.builder()
                            ...
                            .petType(getPetType(upkind))
                            .kindCd(getKindCd(item.optString("kindCd", null)))
